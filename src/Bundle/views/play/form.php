            ...
            <table>
                <tbody class="results">
                    ...
                    while ($match = $matches->getRowFields()) { ?>
                        ...
                        ?>
                        <tr class="match-hour">
                            <td colspan="4"><h6 style="text-align: center"><?= $hour ?></td>
                        </tr>
                        <tr class="match-line">
                            <td class="load-team"><?= $name1 ?></td>
                            <td class="load-flag"><img src="../images/band/<?= $flag1 ?>" height="150" width="150"alt=""></td>
                            ...
                            <td class="load-flag"><img src="../images/band/<?= $flag2 ?>" height="150" width="150"alt=""></td>
