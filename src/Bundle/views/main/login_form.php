...
<article class="grid">
    <div>
        <hgroup>
            <h1><?= $app ?> </h1><h1 style="text-align: center"><img src="../images/wc2022.png" height="100" width="100" alt="Image resize">
            <h2 style="text-align: center"><?= LOGIN_TEXT ?></h2>
        </hgroup>
    ...
    <div class="login-image">
        <h1 style="text-align: center"><img src="../images/qatar.png" height="300" width="300" alt="">
    </div>
</article>